...
from gui.widgets import task_panel_action_helpers as _action_helpers
...
ACTION_TYPE_LABELS = _action_helpers.ACTION_TYPE_LABELS
MAIN_ACTION_TYPE_GROUPS = _action_helpers.MAIN_ACTION_TYPE_GROUPS
FAIL_ACTION_TYPE_GROUPS = _action_helpers.FAIL_ACTION_TYPE_GROUPS
DRAG_COORDINATE_MODE_LABELS = _action_helpers.DRAG_COORDINATE_MODE_LABELS
DRAG_START_MODE_LABELS = _action_helpers.DRAG_START_MODE_LABELS
DRAG_VECTOR_MODE_LABELS = _action_helpers.DRAG_VECTOR_MODE_LABELS
CLICK_OFFSET_HINT_TEXT = _action_helpers.CLICK_OFFSET_HINT_TEXT
RECOGNITION_TARGET_MODE_SHORT_LABELS = _action_helpers.RECOGNITION_TARGET_MODE_SHORT_LABELS
IMAGE_MATCH_MODE_SHORT_LABELS = _action_helpers.IMAGE_MATCH_MODE_SHORT_LABELS
RECOGNITION_ROI_MODE_SHORT_LABELS = _action_helpers.RECOGNITION_ROI_MODE_SHORT_LABELS

_populate_grid_mode_combo = _action_helpers.populate_grid_mode_combo
_populate_image_match_mode_combo = _action_helpers.populate_image_match_mode_combo
_populate_recognition_roi_mode_combo = _action_helpers.populate_recognition_roi_mode_combo
_populate_remove_coord_mode_combo = _action_helpers.populate_remove_coord_mode_combo
_populate_grouped_action_type_combo = _action_helpers.populate_grouped_action_type_combo
_format_recognition_roi_summary = _action_helpers.format_recognition_roi_summary
_coerce_grid_radius = _action_helpers.coerce_grid_radius
_format_traverse_grid_detail = _action_helpers.format_traverse_grid_detail
_format_surrounding_coords_detail = _action_helpers.format_surrounding_coords_detail
_format_remove_target_coords_detail = _action_helpers.format_remove_target_coords_detail
_format_find_road_path_detail = _action_helpers.format_find_road_path_detail
_format_save_recognition_coords_detail = _action_helpers.format_save_recognition_coords_detail
_format_recognition_to_logic_summary = _action_helpers.format_recognition_to_logic_summary
_coerce_drag_start_ratio = _action_helpers.coerce_drag_start_ratio
_coerce_drag_vector_component = _action_helpers.coerce_drag_vector_component
_coerce_highlight_duration_ms = _action_helpers.coerce_highlight_duration_ms
_highlight_duration_seconds_from_ms = _action_helpers.highlight_duration_seconds_from_ms
_coerce_action_bool = _action_helpers.coerce_action_bool
_coerce_point_ratio = _action_helpers.coerce_point_ratio
_get_action_point_values = _action_helpers.get_action_point_values
_get_highlight_point_values = _action_helpers.get_highlight_point_values
_format_action_point_summary = _action_helpers.format_action_point_summary
_format_highlight_match_summary = _action_helpers.format_highlight_match_summary
_format_highlight_point_summary = _action_helpers.format_highlight_point_summary
_format_drag_vector_component = _action_helpers.format_drag_vector_component
_configure_point_coordinate_spins = _action_helpers.configure_point_coordinate_spins
_configure_click_offset_spins = _action_helpers.configure_click_offset_spins
_sync_click_offset_mode_combo_with_point_mode = _action_helpers.sync_click_offset_mode_combo_with_point_mode
_get_screen_drag_vector_values = _action_helpers.get_screen_drag_vector_values
_set_combo_data = _action_helpers.set_combo_data
